...
class CaseData:
    ...
    ----------
        ...
        binder_centroid_angle:
            The angle between binder-centroid-binder in degrees.

        binder_adjacent_torsion:
            The torsion of binder-adjacent-adjacent-binder.

        binder_angles:
            The binder reaction angles.

        binder_angles:
            The angle between binder-adjacent vectors.
