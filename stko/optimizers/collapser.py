...
#
#
# print(lb_ids, lb_vector, lb_length)
# bb_id_1, bb_id_2 = (
#     i.get_building_block_id()
#     for i in mol.get_atom_infos(atom_ids=lb_ids)
# )
# print(bb_id_1, bb_id_2)
#
# cent_vector_1 = centroid_to_lb_vectors[
#     (bb_id_1, lb_ids[0])
# ]
...
#     (bb_id_2, lb_ids[1])
# ]
# print(cent_vector_1, cent_vector_2)
# if bb_id_1 in constrained_bbs and bb_id_2 in constrained_bbs:
#     raise ValueError('issues!')
# moving_bb = (
#     bb_id_1 if bb_id_1 not in constrained_bbs else bb_id_2
# )
# constrained_bbs.add(moving_bb)
# print('cbps', constrained_bbs)
# # if len(constrained_bb_sets) == 0:
# #     constrained_bb_sets[len(constrained_bb_sets)] = set(
# #         [bb_id_1]
# #     )
# # else:
# #     in_cbs = False
# #     for cbs_id in constrained_bb_sets:
# #         cbs = constrained_bb_sets[cbs_id]
# #         print(cbs_id, constrained_bb_sets[cbs_id])
# #         paired_bbs = []
# #         if bb_id_1 in cbs:
# #             paired_bbs = [i for i in cbs if i != bb_id_1]
# #             for pbb in paired_bbs:
# #                 moving_bbs.add(paired_bbs)
# #             cbs.add(bb_id_1)
# #             in_cbs = True
# #         print(paired_bbs)
# #     if not in_cbs:
...
# #         )
# #
# # print('mbs', moving_bbs)
# # print('cbps', constrained_bb_sets)
# # input()
# # Get all atoms in  building blocks to moved,
# moving_bb_atom_ids = (
#     i.get_atom().get_id()
#     for i in mol.get_atom_infos()
#     if i.get_building_block_id() == moving_bb
# )
#
# # Move along lb_vector enought o decrease to target length
# delta_dist = lb_length - self._target_bond_length
# print(f's{step}', delta_dist)
# translation_vector = -lb_vector * (delta_dist/(2*lb_length))
#
# # Update atom position of building block.
# mol = self._translate_atoms_along_vector(
#     mol=mol,
...
# for long_bond_ids in long_bond_infos:
#     long_bond = long_bond_infos[long_bond_ids]
#     print(long_bond_ids, self._get_bond_length(
#         mol=mol,
#         bond=long_bond.get_bond()
#     ))
